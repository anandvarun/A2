  ...
  public void windowClosing(WindowEvent e) {
    ...
    try
        ...
        String quey="update track set logoutTime='"+ timeStamp + "' where username='"+ 
                userName +"' and logoutTime='0' and loggedInto = 'OrdersApp'";
    ...
    private void initComponents() {
        ...
        jButton8.setText("Reference Material");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(jScrollPane4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE)
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        // getting the culture boxes from inventory. Once retieved, the culture boxes inventory is
        // displayed in jTextArea1. From here the user can select an inventory
        // item by triple clicking the item.
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
         // jButton6 is responsible for querying the inventory database and
        // getting the Genomics from inventory. Once retieved, the Genomics inventory is
        // displayed in jTextArea1. From here the user can select an inventory
        // item by triple clicking the item.
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        // TODO add your handling code here:
         // jButton6 is responsible for querying the inventory database and
        // getting the reference material from inventory. Once retieved, the reference material inventory is
        // displayed in jTextArea1. From here the user can select an inventory
        // item by triple clicking the item.
        ...
        // If we are connected, then we get the list of reference material from the
        // inventory database
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
         ...
         // jButton6 is responsible for querying the inventory database and
        // getting the processing from inventory. Once retieved, the processing inventory is
        // displayed in jTextArea1. From here the user can select an inventory
        // item by triple clicking the item.
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        System.out.println("Tracked");
        String quey="update track set logoutTime='"+ timeStamp + "' where username='"+ 
                this.userName +"' and logoutTime='0' and loggedInto = 'OrdersApp'";
        stmt.executeUpdate(quey);
        dispose();
        } catch(Exception e){
            String errString =  "\nProblem accessing login repository:: " + e;
                jTextArea1.append(errString);
        }
